...
export default function Account() {
  ...
  return (
    <Box className={style.accountCon}>
      <Box>
        <Typography className={style.accountText} sx={{ fontSize: "2.5rem" }}>
          Account
        </Typography>
      </Box>
      <Box className={style.accountCards}>
        <Box className={style.accountProfile}>
          <Card className={style.accountCard} sx={{ boxShadow: "0" }}>
            <CardContent className={style.accountCardContent}>
              <Avatar
                className={style.accountContentImg}
                alt="profile"
              ...
              />
              <Typography variant="h6" className={style.accountContentTexthead}>
                Sofia Rivers
              </Typography>
              <Typography className={style.accountContentTextpara}>
                Los Angeles USA
              </Typography>
              <Typography className={style.accountContentTextTime}>
                GTM-7
              </Typography>
            </CardContent>
            <CardActions>
              <Button sx={{ color: "#635bff", paddingBlock: "1rem" }}>
                Upload Picture
              </Button>
            </CardActions>
          </Card>
        </Box>
        <Box className={style.accountForm}>
          <Box className={style.formHead}>
            <Typography variant="h6">
              Profile
            </Typography>
            <Typography variant="body2" className={style.formHeadPara}>
              The Information can be edited
            </Typography>
          </Box>
          <Box className={style.formFieldsCon}>
            <TextField className={style.formFields} label="First name" />
            <TextField className={style.formFields} label="Last name" />
            <TextField className={style.formFields} label="Email address" />
            <TextField className={style.formFields} label="Phone number" />
            <TextField className={style.formFields} label="State"  select />
            <TextField className={style.formFields} label="City" />
          </Box>
